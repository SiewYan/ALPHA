...
selection = {
    ...
    'ZmmINC' : "triggerMET && isZtoMM && Lepton1.isMuon && Lepton2.isMuon && ((Lepton1.pt>30 && Lepton1.isTight && Lepton2.pt>10 && Lepton2.isLoose)||(Lepton1.pt>10 && Lepton1.isLoose && Lepton2.pt>30 && Lepton2.isTight)) && V.mass > 70 && V.mass<110",
    ...
    #'WenINC' : "triggerMET && isWtoEN && Lepton1.isElectron && Lepton1.pt>30 && Lepton1.isTight && V.tmass>50",
    ...
    'WenCR' : "WenINC && hadronicRecoil.pt>200 && nElectrons==1 && nMuons==0 && nJets<4 && nTaus==0 && nPhotons==0 && Jet1.isLoose && Jet1.pt>50 && V.tmass>50 && V.tmass<160 && MEt.pt>40",
